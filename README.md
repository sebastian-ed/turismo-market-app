...
- Descargar un PDF del informe ejecutivo, de las respuestas individuales o de ambos contenidos.

Para evitar accidentes, cualquier eliminación —individual, seleccionada o filtrada— abre una advertencia bloqueante y exige escribir exactamente `ELIMINAR DEFINITIVAMENTE`.
...
### 4. Exportación PDF configurable

Desde el botón **PDF** del panel admin podés elegir:

- **Informe ejecutivo**: indicadores, cuatro gráficos, oportunidades priorizadas, palabras frecuentes y frases hair-on-fire.
- **Respuestas individuales**: cada formulario completo con el nombre del destino en el título.
- **Ambos contenidos** dentro del mismo documento.
- Para las respuestas individuales, usar todas las visibles según filtros o solamente las seleccionadas en la tabla.

El nombre del archivo y los encabezados identifican el destino cuando hay uno solo, o la cantidad y listado de destinos cuando el informe combina varios. La generación se realiza en el navegador y no requiere cambios en Supabase.
